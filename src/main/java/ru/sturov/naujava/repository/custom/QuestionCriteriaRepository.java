 ...
 *
 * <p>Содержит аналоги запросов из {@link ru.sturov.naujava.repository.QuestionRepository},
 * но построенные программно через JPA Criteria API.
 */
public interface QuestionCriteriaRepository {
     ...
     */
    List<Question> searchByDifficultyLevelAndCategoryNameUsingCriteria(
